...
- 기존 주소: http://localhost:3000/cinema
- 개발·프로덕션 모두 기본 포트 3000입니다. 원본 HUD가 3000번에서 실행 중이면 먼저 해당 서버를 정상 종료한 뒤 실행하세요. 이 분리 작업은 기존 서버를 종료하지 않습니다.
...
- 원본 코드·서버는 변경하지 않았습니다. 새 서버의 브라우저 실행은 기존 3000번 서버를 종료한 후 진행하세요.