...
C:\Project\hud의 CINEMA를 분리한 독립 Next.js 프로젝트입니다. HATCHERY 메인 화면과 16개 연출, 카메라 얼굴 추적, 대화 기록 배경, 시동 버튼·기동 효과음, OpenAI Realtime 음성과 OpenAI·ChatGPT·Anthropic·Gemini·Mistral 텍스트 대화, 로봇 음색 설정을 포함합니다. 제조 정보는 시연 데이터입니다.
...
- src/server/cinema: 서버 전용 AI 제공자 요청과 OpenAI Realtime 연결
