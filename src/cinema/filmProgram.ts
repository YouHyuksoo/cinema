...
export const FILM_DURATIONS = { wave: ENVIRONMENT_FILM_SECONDS, gears: 28, scan: 22, unfold: 32, trace: TRACE_TIMING.endAt, console: 28, visor: SMT_FACTORY_SECONDS, visorPan: 32,
  ...
  network: PROCESS_NETWORK_SECONDS, energy: ENERGY_CORE_SECONDS, product: PRODUCT_INSPECTION_SECONDS, spc: SPC_FILM_SECONDS, cctv: CCTV_FILM_SECONDS, space3d: 45 } as const;
...
export const FILM_CHAPTERS = [
  ...
  { id: 'bars', title: '마운터 분석', subtitle: '라인 내 최대 5대 · PCB 흐름 · 설비별 품질 진단', duration: FILM_DURATIONS.bars, previewAt: 17 },
  { id: 'pie', title: '차트 분석', subtitle: '파이 · 선 · 막대 · 영역 · 산포 · 2D/3D', duration: FILM_DURATIONS.pie, previewAt: 17 },
  ...
  { id: 'space3d', title: '공장 3D', subtitle: '직접 돌려보고 확대하고 안으로 들어가기', duration: FILM_DURATIONS.space3d, previewAt: 2 },
] as const;
